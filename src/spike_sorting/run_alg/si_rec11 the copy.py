...
#         self.chans = recording.get_channel_ids()# range(recording.get_num_channels())
...
#         return self.recording.get_traces(start_frame=frames.start, end_frame=frames.stop, channel_ids=chans).T

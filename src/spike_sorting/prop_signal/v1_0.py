...
def prop_signal(spike_times, thres_freq, seconds_recording, thres_number_spikes, ratio, thres_cooccurrences, p,
                                    small_window=0.5, big_window=2, ccg_before=1.5, ccg_after=1.5, ccg_n_bins=61):
    """
...
def format_thresh_crossings(thresh_crossings):
    ...
    return [np.array(st) for st in thresh_crossings]
...
if __name__ == "__main__":
    ...
    scan_reference_electrode(spike_times, 1, 180, None, 0.5)

...
class Recording:
    def __init__(self, path, freq_min=300, freq_max=6000, rec_name=""):
        ...
        rec_filt = scale(self.rec_raw, gain=self.rec_raw.get_channel_gains(), offset=self.rec_raw.get_channel_offsets(), dtype="float32")
    ...
    def get_traces_raw(self, start_frame, end_frame, channel_ind=None):
        return Recording._get_traces(self.rec_raw, start_frame, end_frame, channel_ind)

    def get_traces_filt(self, start_frame, end_frame, channel_ind=None):
    ...
    def plot_waveform(self, st, chan_center=None, n_before=40, n_after=40,
        ...
        WINDOW_HALF_SIZE = 130  # length and width of window will be WINDOW_HALF_SIZE * 2
        SCALE_W = 0.35  # Multiply width of waveform by this to scale it down
        SCALE_H = 0.6 #*6  # Multiple height of waveform by this to scale it down
        ...
        a1.set_xlim(-WINDOW_HALF_SIZE, WINDOW_HALF_SIZE)
    ...
    @staticmethod
    def _get_traces(rec, start_frame, end_frame, channel_ind=None):
